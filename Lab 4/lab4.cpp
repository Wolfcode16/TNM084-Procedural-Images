...
// ========== TASKS ==========
// Task 1: Tesselation level at 10 would probably suffice, less and it would
//         be too polygony, more and you would probably see minimal difference.
//
// Task 2:
//      - Normalize every position vector to length = 1.0 from origin.
//      - Gaps/cracks happen due to insufficient vertices between cubes corners.
//      - When the vertices normalize to the sphere surface, triangles stretch
//        and may not connect properly/smoothly, creating gaps/cracks.
//        Tessellation level of 10+ provides enough vertices to smoothly cover
//        the spehere surface.
//
// Task 3:
//      - Used noise(vec3) 3D noise function over the sphere.
//      - Sampled the noise function at the normalized vertex points.
//        Scaled it by noiseScale, used the noise value to displace the vertex
//        a long its normal direction.
//
// Task 4:
//      - 3 bands gave a nice look, more than that was indistinguishable.
//      - After Task 6: 25+ bands were needed...
//
// Task 5:
//      -
...
GLint TessLevelInner = 60;
GLint TessLevelOuter1 = 60;
GLint TessLevelOuter2 = 60;
GLint TessLevelOuter3 = 60;
...
void init(void)
{
	...
	// Task 6
	float displacementAmount = 0.3;
	glUniform1f(glGetUniformLocation(shader, "displacementAmount"), displacementAmount);
